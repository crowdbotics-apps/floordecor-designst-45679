"""
Django settings for floordecor_designst_45679 project.
...
ROOT_URLCONF = 'floordecor_designst_45679.urls'
...
WSGI_APPLICATION = 'floordecor_designst_45679.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floordecor_designst_45679 API",
    "DESCRIPTION": "API documentation for floordecor_designst_45679 App",
    "VERSION": "v1",
}
